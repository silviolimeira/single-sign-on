...
INSERT INTO users(USERNAME, PASSWORD, ACCOUNT_NON_EXPIRED, ACCOUNT_NON_LOCKED, CREDENTIALS_NON_EXPIRED, ENABLED, FIRST_NAME, LAST_NAME, EMAIL_ADDRESS, BIRTH_DATE) VALUES ('Admin', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG', true, true, true, true, 'Admin', 'Sky', 'admin@gmail.com', '2023-02-24');
